...
<div class="input-group">
  <span class="input-group-addon">
    ...
    <input placeholder="Sink Title" name="titleJS" class="input" [(ngModel)]="sink.title" onkeydown="if (event.keyCode == 13) document.getElementById('btnAddSinks').click()"
...
export class SinkFormComponent implements OnInit {
  ...
  constructor(private sinkSvc: SinksService, private route: ActivatedRoute) {}

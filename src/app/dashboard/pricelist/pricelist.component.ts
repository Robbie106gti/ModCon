  ...
  <div class="col-xs-6 col-sm-7 col-sm-offset-1">
    ...
    <div class="">
      ...
      <span *ngIf="!ncedit" (click)="setNc()">NC Discount {{ sum?.ncDiscount | percent}}
        <i class="fa fa-pencil-square-o" aria-hidden="true" (click)="setNc()"></i>
      </span>
      <div>
...
<div class="row">
  <div class="col-md-10 col-md-offset-1">
    <ul class="nav nav-tabs">
      <li class="active">
        <a data-toggle="tab" href="#home">Canadian prices</a>
      </li>
      <li>
        <a data-toggle="tab" href="#menu1">USA prices</a>
      </li>
      <li>
        <a data-toggle="tab" href="#menu2">NC DL Discount Canadian</a>
      </li>
      <li>
        <a data-toggle="tab" href="#menu3">NC DL Discount USA</a>
      </li>
    </ul>
  ...
  <ng-template #woEdit>
    <form class="form-group">
      <input #woEdit name="text" (keyup.enter)="updateWo(woEdit.value)" class="form-control" [(ngModel)]="sum.WalnutOak" type="text"
      />
    </form>
  </ng-template>
  ...
  <ng-template #ncEdit>
    <form class="form-group">
      <input #discEdit name="text" (keyup.enter)="updateNc(discEdit.value)" class="form-control" [(ngModel)]="sum.ncDiscount" type="text"
      />
    </form>
  </ng-template>
</div>

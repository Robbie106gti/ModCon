  ...
  <div class="thumbnail" *ngIf="user$ | async as user">
    ...
    <div class="caption">
      <a [routerLink]="[skew.title, 'options']">
        ...
        <p class="hidden" *ngIf="user$ | async as user">Base price:<br>
...
export class SkewViewComponent implements OnInit {
  ...
  noImage =
    'https://firebasestorage.googleapis.com/v0/b/modcon-2b3c7.appspot.com/o/assets%2F' +
    'noImage-01.jpg?alt=media&token=6a82abe8-8d8b-4ad0-93c5-b6398c03fc24';
